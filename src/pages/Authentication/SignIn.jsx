...
const SignIn = () => {
  ...
  // Fungsi untuk mengatur nilai email saat input berubah
  const handleEmailChange = (event) => {
    setEmail(event.target.value);
  };

  // Fungsi untuk mengatur nilai password saat input berubah
  ...
  return (
    <>
      <div className="relative align-middle justify-center items-center rounded-sm bg-white shadow-lg w-3/5 mx-auto my-8">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-auto xl:block xl:w-1/2">
              ...
              <form onSubmit={handleLogin}>
                ...
                <div className="mb-5">
                  <button
                    type="submit"
                    value="Sign In"
                    className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 transition hover:bg-opacity-90 text-black"
                  >Sign In</button>
                </div>
